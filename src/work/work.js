...
export default function Work(){
    return (
        <div className="Work relative w-full h-full p-32">
            {/* <Work_ellipse /> */}
             <div className="w-[140px] h-[35px] top-[80px] absolute left-[] flex flex-row justify-around">
                <div className="flex flex-row justify-center items-center ">
                    ...
                    <h4 className="w-[116px] h-[35px] top-[] left-[]  font-sansation text-[20px] tracking-[0px]  text-[#61FF00] leading-[34px] font-[400] ">Our Work</h4>
            </div>
            <WorkDetails />
